...
class Node:
    ...
    def gini_best_score(self, y, possible_splits):
        ...
        for idx in possible_splits:
            ...
            total_size = left + right

            gini_gain = 1 - (left/total_size)*gini_left - (right/total_size)*gini_right
    ...
    def calculate_gini(self, labels):
        pos = np.count_nonzero(labels)  # occurrences of 1
        neg = len(labels) - pos  # occurrences of 0
        total = len(labels)
